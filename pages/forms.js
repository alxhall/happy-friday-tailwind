                  ...
                  <div className="col-span-3 sm:col-span-2">
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                      ...
                      <input
                        type="text"
                        id="company_website"
                        className="focus:ring-indigo-500 focus:border-indigo-500 px-3 flex-1 border block border-1 w-full rounded-none rounded-r-md sm:text-sm border-gray-300"
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <textarea
                      id="about"
                      rows="3"
                      className="shadow-sm border p-3 focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md"
